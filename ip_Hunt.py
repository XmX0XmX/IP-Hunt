    ...
    while (count==4):
        ...
        for t in config_files_list:
            if os.path.isfile(t):
                ...
                url='curl -H \'Authorization: token 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\' -H \'Accept: application/vnd.github.v3.raw\' -O -L https://raw.githubusercontent.com/XmX0XmX/IP-Hunt/main/'+str(t)
                #print(url)
                os.system(url)
                print("\n")
                print("*"*100)
